...
#[doc = "Field `REFGENACT` reader - 8:8\\]
Reference generator active"]
...
#[doc = "Field `REFGENACT` writer - 8:8\\]
Reference generator active"]
pub type RefgenactW<'a, REG> = crate::BitWriter<'a, REG, Refgenact>;
impl<'a, REG> RefgenactW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Reference generator not active"]
    #[inline(always)]
    pub fn refgenact_0(self) -> &'a mut crate::W<REG> {
        self.variant(Refgenact::Refgenact0)
    }
    #[doc = "Reference generator active"]
    #[inline(always)]
    pub fn refgenact_1(self) -> &'a mut crate::W<REG> {
        self.variant(Refgenact::Refgenact1)
    }
}
#[doc = "9:9\\]
...
#[doc = "Field `REFBGACT` writer - 9:9\\]
Reference bandgap active"]
pub type RefbgactW<'a, REG> = crate::BitWriter<'a, REG, Refbgact>;
impl<'a, REG> RefbgactW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Reference bandgap buffer not active"]
    #[inline(always)]
    pub fn refbgact_0(self) -> &'a mut crate::W<REG> {
        self.variant(Refbgact::Refbgact0)
    }
    #[doc = "Reference bandgap buffer active"]
    #[inline(always)]
    pub fn refbgact_1(self) -> &'a mut crate::W<REG> {
        self.variant(Refbgact::Refbgact1)
    }
}
#[doc = "10:10\\]
...
#[doc = "Field `REFGENBUSY` reader - 10:10\\]
Reference generator busy"]
...
#[doc = "Field `REFGENBUSY` writer - 10:10\\]
Reference generator busy"]
pub type RefgenbusyW<'a, REG> = crate::BitWriter<'a, REG, Refgenbusy>;
impl<'a, REG> RefgenbusyW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Reference generator not busy"]
    #[inline(always)]
    pub fn refgenbusy_0(self) -> &'a mut crate::W<REG> {
        self.variant(Refgenbusy::Refgenbusy0)
    }
    #[doc = "Reference generator busy"]
    #[inline(always)]
    pub fn refgenbusy_1(self) -> &'a mut crate::W<REG> {
        self.variant(Refgenbusy::Refgenbusy1)
    }
}
#[doc = "11:11\\]
Bandgap mode\n\nValue on reset: 0"]
...
#[doc = "Field `REFGENRDY` reader - 12:12\\]
Variable reference voltage ready status"]
...
#[doc = "Field `REFGENRDY` writer - 12:12\\]
Variable reference voltage ready status"]
...
#[doc = "Field `REFBGRDY` reader - 13:13\\]
Buffered bandgap voltage ready status"]
...
#[doc = "Field `REFBGRDY` writer - 13:13\\]
Buffered bandgap voltage ready status"]
...
Reference generator active"]
    #[inline(always)]
    #[must_use]
    pub fn refgenact(&mut self) -> RefgenactW<Refctl0Spec> {
...
Reference bandgap active"]
    #[inline(always)]
    #[must_use]
    pub fn refbgact(&mut self) -> RefbgactW<Refctl0Spec> {
...
Reference generator busy"]
    #[inline(always)]
    #[must_use]
    pub fn refgenbusy(&mut self) -> RefgenbusyW<Refctl0Spec> {
...
Bandgap mode"]
    #[inline(always)]
    #[must_use]
    pub fn bgmode(&mut self) -> BgmodeW<Refctl0Spec> {
        BgmodeW::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Variable reference voltage ready status"]
    #[inline(always)]
    #[must_use]
    pub fn refgenrdy(&mut self) -> RefgenrdyW<Refctl0Spec> {
...
Buffered bandgap voltage ready status"]
    #[inline(always)]
    #[must_use]
    pub fn refbgrdy(&mut self) -> RefbgrdyW<Refctl0Spec> {
