...
#[doc = "Field `P5IV` writer - 4:0\\]
Port 5 interrupt vector value"]
pub type P5ivW<'a, REG> = crate::FieldWriter<'a, REG, 5, P5iv>;
impl<'a, REG> P5ivW<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn none(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::None)
    }
    #[doc = "Interrupt Source: Port 5.0 interrupt; Interrupt Flag: P5IFG0; Interrupt Priority: Highest"]
    #[inline(always)]
    pub fn p5ifg0(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::P5ifg0)
    }
    #[doc = "Interrupt Source: Port 5.1 interrupt; Interrupt Flag: P5IFG1"]
    #[inline(always)]
    pub fn p5ifg1(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::P5ifg1)
    }
    #[doc = "Interrupt Source: Port 5.2 interrupt; Interrupt Flag: P5IFG2"]
    #[inline(always)]
    pub fn p5ifg2(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::P5ifg2)
    }
    #[doc = "Interrupt Source: Port 5.3 interrupt; Interrupt Flag: P5IFG3"]
    #[inline(always)]
    pub fn p5ifg3(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::P5ifg3)
    }
    #[doc = "Interrupt Source: Port 5.4 interrupt; Interrupt Flag: P5IFG4"]
    #[inline(always)]
    pub fn p5ifg4(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::P5ifg4)
    }
    #[doc = "Interrupt Source: Port 5.5 interrupt; Interrupt Flag: P5IFG5"]
    #[inline(always)]
    pub fn p5ifg5(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::P5ifg5)
    }
    #[doc = "Interrupt Source: Port 5.6 interrupt; Interrupt Flag: P5IFG6"]
    #[inline(always)]
    pub fn p5ifg6(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::P5ifg6)
    }
    #[doc = "Interrupt Source: Port 5.7 interrupt; Interrupt Flag: P5IFG7; Interrupt Priority: Lowest"]
    #[inline(always)]
    pub fn p5ifg7(self) -> &'a mut crate::W<REG> {
        self.variant(P5iv::P5ifg7)
    }
}
impl R {
    #[doc = "Bits 0:4 - 4:0\\]
...
Port 5 interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn p5iv(&mut self) -> P5ivW<P5ivSpec> {
        P5ivW::new(self, 0)
    }
}
