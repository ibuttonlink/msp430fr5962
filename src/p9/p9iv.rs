...
#[doc = "Field `P9IV` writer - 4:0\\]
Port 9 interrupt vector value"]
pub type P9ivW<'a, REG> = crate::FieldWriter<'a, REG, 5, P9iv>;
impl<'a, REG> P9ivW<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn none(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::None)
    }
    #[doc = "Interrupt Source: Port 9.0 interrupt; Interrupt Flag: P9IFG0; Interrupt Priority: Highest"]
    #[inline(always)]
    pub fn p9ifg0(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::P9ifg0)
    }
    #[doc = "Interrupt Source: Port 9.1 interrupt; Interrupt Flag: P9IFG1"]
    #[inline(always)]
    pub fn p9ifg1(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::P9ifg1)
    }
    #[doc = "Interrupt Source: Port 9.2 interrupt; Interrupt Flag: P9IFG2"]
    #[inline(always)]
    pub fn p9ifg2(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::P9ifg2)
    }
    #[doc = "Interrupt Source: Port 9.3 interrupt; Interrupt Flag: P9IFG3"]
    #[inline(always)]
    pub fn p9ifg3(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::P9ifg3)
    }
    #[doc = "Interrupt Source: Port 9.4 interrupt; Interrupt Flag: P9IFG4"]
    #[inline(always)]
    pub fn p9ifg4(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::P9ifg4)
    }
    #[doc = "Interrupt Source: Port 9.5 interrupt; Interrupt Flag: P9IFG5"]
    #[inline(always)]
    pub fn p9ifg5(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::P9ifg5)
    }
    #[doc = "Interrupt Source: Port 9.6 interrupt; Interrupt Flag: P9IFG6"]
    #[inline(always)]
    pub fn p9ifg6(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::P9ifg6)
    }
    #[doc = "Interrupt Source: Port 9.7 interrupt; Interrupt Flag: P9IFG7; Interrupt Priority: Lowest"]
    #[inline(always)]
    pub fn p9ifg7(self) -> &'a mut crate::W<REG> {
        self.variant(P9iv::P9ifg7)
    }
}
impl R {
    #[doc = "Bits 0:4 - 4:0\\]
...
Port 9 interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn p9iv(&mut self) -> P9ivW<P9ivSpec> {
        P9ivW::new(self, 0)
    }
}
