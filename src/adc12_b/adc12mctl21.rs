...
Input channel select"]
    #[inline(always)]
    #[must_use]
    pub fn adc12inch(&mut self) -> Adc12inchW<Adc12mctl21Spec> {
...
End of sequence"]
    #[inline(always)]
    #[must_use]
    pub fn adc12eos(&mut self) -> Adc12eosW<Adc12mctl21Spec> {
...
reference selection"]
    #[inline(always)]
    #[must_use]
    pub fn adc12vrsel(&mut self) -> Adc12vrselW<Adc12mctl21Spec> {
...
Differential mode."]
    #[inline(always)]
    #[must_use]
    pub fn adc12dif(&mut self) -> Adc12difW<Adc12mctl21Spec> {
...
Comparator window enable"]
    #[inline(always)]
    #[must_use]
    pub fn adc12winc(&mut self) -> Adc12wincW<Adc12mctl21Spec> {
