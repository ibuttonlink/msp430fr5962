...
Input channel select"]
    #[inline(always)]
    #[must_use]
    pub fn adc12inch(&mut self) -> Adc12inchW<Adc12mctl11Spec> {
...
End of sequence"]
    #[inline(always)]
    #[must_use]
    pub fn adc12eos(&mut self) -> Adc12eosW<Adc12mctl11Spec> {
...
reference selection"]
    #[inline(always)]
    #[must_use]
    pub fn adc12vrsel(&mut self) -> Adc12vrselW<Adc12mctl11Spec> {
...
Differential mode."]
    #[inline(always)]
    #[must_use]
    pub fn adc12dif(&mut self) -> Adc12difW<Adc12mctl11Spec> {
...
Comparator window enable"]
    #[inline(always)]
    #[must_use]
    pub fn adc12winc(&mut self) -> Adc12wincW<Adc12mctl11Spec> {
