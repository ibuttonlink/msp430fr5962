...
pub type R = crate::R<P7sel0Spec>;
#[doc = "Register `P7SEL0` writer"]
pub type W = crate::W<P7sel0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0W<P7sel0Spec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1W<P7sel0Spec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - P2"]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2W<P7sel0Spec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - P3"]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3W<P7sel0Spec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - P4"]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4W<P7sel0Spec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - P5"]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5W<P7sel0Spec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - P6"]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6W<P7sel0Spec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - P7"]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7W<P7sel0Spec> {
        P7W::new(self, 7)
    }
}
#[doc = "Port 7 Select 0\n\nYou can [`read`](crate::Reg::read) this register and get [`p7sel0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p7sel0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P7sel0Spec;
impl crate::RegisterSpec for P7sel0Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`p7sel0::R`](R) reader structure"]
impl crate::Readable for P7sel0Spec {}
#[doc = "`write(|w| ..)` method takes [`p7sel0::W`](W) writer structure"]
impl crate::Writable for P7sel0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets P7SEL0 to value 0"]
impl crate::Resettable for P7sel0Spec {
