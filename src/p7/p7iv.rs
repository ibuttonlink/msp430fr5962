...
#[doc = "Field `P7IV` writer - 4:0\\]
Port 7 interrupt vector value"]
pub type P7ivW<'a, REG> = crate::FieldWriter<'a, REG, 5, P7iv>;
impl<'a, REG> P7ivW<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn none(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::None)
    }
    #[doc = "Interrupt Source: Port 7.0 interrupt; Interrupt Flag: P7IFG0; Interrupt Priority: Highest"]
    #[inline(always)]
    pub fn p7ifg0(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::P7ifg0)
    }
    #[doc = "Interrupt Source: Port 7.1 interrupt; Interrupt Flag: P7IFG1"]
    #[inline(always)]
    pub fn p7ifg1(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::P7ifg1)
    }
    #[doc = "Interrupt Source: Port 7.2 interrupt; Interrupt Flag: P7IFG2"]
    #[inline(always)]
    pub fn p7ifg2(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::P7ifg2)
    }
    #[doc = "Interrupt Source: Port 7.3 interrupt; Interrupt Flag: P7IFG3"]
    #[inline(always)]
    pub fn p7ifg3(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::P7ifg3)
    }
    #[doc = "Interrupt Source: Port 7.4 interrupt; Interrupt Flag: P7IFG4"]
    #[inline(always)]
    pub fn p7ifg4(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::P7ifg4)
    }
    #[doc = "Interrupt Source: Port 7.5 interrupt; Interrupt Flag: P7IFG5"]
    #[inline(always)]
    pub fn p7ifg5(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::P7ifg5)
    }
    #[doc = "Interrupt Source: Port 7.6 interrupt; Interrupt Flag: P7IFG6"]
    #[inline(always)]
    pub fn p7ifg6(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::P7ifg6)
    }
    #[doc = "Interrupt Source: Port 7.7 interrupt; Interrupt Flag: P7IFG7; Interrupt Priority: Lowest"]
    #[inline(always)]
    pub fn p7ifg7(self) -> &'a mut crate::W<REG> {
        self.variant(P7iv::P7ifg7)
    }
}
impl R {
    #[doc = "Bits 0:4 - 4:0\\]
...
Port 7 interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn p7iv(&mut self) -> P7ivW<P7ivSpec> {
        P7ivW::new(self, 0)
    }
}
