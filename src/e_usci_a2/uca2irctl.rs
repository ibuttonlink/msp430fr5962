#[doc = "Register `UCA2IRCTL` reader"]
pub type R = crate::R<Uca2irctlSpec>;
#[doc = "Register `UCA2IRCTL` writer"]
pub type W = crate::W<Uca2irctlSpec>;
#[doc = "0:0\\]
...
#[doc = "Field `UCIRTXCLK` reader - 1:1\\]
IrDA transmit pulse clock select"]
...
#[doc = "Field `UCIRTXCLK` writer - 1:1\\]
IrDA transmit pulse clock select"]
...
#[doc = "Field `UCIRTXPL` reader - 7:2\\]
Transmit pulse length"]
pub type UcirtxplR = crate::FieldReader;
#[doc = "Field `UCIRTXPL` writer - 7:2\\]
Transmit pulse length"]
...
#[doc = "Field `UCIRRXFL` reader - 15:10\\]
Receive filter length"]
pub type UcirrxflR = crate::FieldReader;
#[doc = "Field `UCIRRXFL` writer - 15:10\\]
Receive filter length"]
...
IrDA encoder/decoder enable"]
    #[inline(always)]
    #[must_use]
    pub fn uciren(&mut self) -> UcirenW<Uca2irctlSpec> {
        UcirenW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
IrDA transmit pulse clock select"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxclk(&mut self) -> UcirtxclkW<Uca2irctlSpec> {
...
Transmit pulse length"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxpl(&mut self) -> UcirtxplW<Uca2irctlSpec> {
...
IrDA receive filter enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ucirrxfe(&mut self) -> UcirrxfeW<Uca2irctlSpec> {
...
IrDA receive input UCAxRXD polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ucirrxpl(&mut self) -> UcirrxplW<Uca2irctlSpec> {
...
Receive filter length"]
    #[inline(always)]
    #[must_use]
    pub fn ucirrxfl(&mut self) -> UcirrxflW<Uca2irctlSpec> {
        UcirrxflW::new(self, 10)
    }
}
#[doc = "eUSCI_Ax IrDA Control Word Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca2irctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca2irctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca2irctlSpec;
impl crate::RegisterSpec for Uca2irctlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca2irctl::R`](R) reader structure"]
impl crate::Readable for Uca2irctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uca2irctl::W`](W) writer structure"]
impl crate::Writable for Uca2irctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA2IRCTL to value 0"]
impl crate::Resettable for Uca2irctlSpec {
