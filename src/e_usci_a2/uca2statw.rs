#[doc = "Register `UCA2STATW` reader"]
pub type R = crate::R<Uca2statwSpec>;
#[doc = "Register `UCA2STATW` writer"]
pub type W = crate::W<Uca2statwSpec>;
#[doc = "0:0\\]
eUSCI_A busy\n\nValue on reset: 0"]
...
eUSCI_A busy"]
    #[inline(always)]
    #[must_use]
    pub fn ucbusy(&mut self) -> UcbusyW<Uca2statwSpec> {
        UcbusyW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Address received / Idle line detected"]
    #[inline(always)]
    #[must_use]
    pub fn ucaddr_ucidle(&mut self) -> UcaddrUcidleW<Uca2statwSpec> {
...
Receive error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxerr(&mut self) -> UcrxerrW<Uca2statwSpec> {
        UcrxerrW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Break detect flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrk(&mut self) -> UcbrkW<Uca2statwSpec> {
        UcbrkW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Parity error flag. When UCPEN = 0, UCPE is read as 0. UCPE is cleared when UCAxRXBUF is read."]
    #[inline(always)]
    #[must_use]
    pub fn ucpe(&mut self) -> UcpeW<Uca2statwSpec> {
        UcpeW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Overrun error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucoe(&mut self) -> UcoeW<Uca2statwSpec> {
        UcoeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Framing error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucfe(&mut self) -> UcfeW<Uca2statwSpec> {
        UcfeW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Listen enable"]
    #[inline(always)]
    #[must_use]
    pub fn uclisten(&mut self) -> UclistenW<Uca2statwSpec> {
        UclistenW::new(self, 7)
    }
}
#[doc = "eUSCI_Ax Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca2statw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca2statw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca2statwSpec;
impl crate::RegisterSpec for Uca2statwSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca2statw::R`](R) reader structure"]
impl crate::Readable for Uca2statwSpec {}
#[doc = "`write(|w| ..)` method takes [`uca2statw::W`](W) writer structure"]
impl crate::Writable for Uca2statwSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA2STATW to value 0"]
impl crate::Resettable for Uca2statwSpec {
