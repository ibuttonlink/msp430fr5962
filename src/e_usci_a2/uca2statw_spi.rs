#[doc = "Register `UCA2STATW_SPI` reader"]
pub type R = crate::R<Uca2statwSpiSpec>;
#[doc = "Register `UCA2STATW_SPI` writer"]
pub type W = crate::W<Uca2statwSpiSpec>;
#[doc = "5:5\\]
Overrun error flag\n\nValue on reset: 0"]
...
Overrun error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucoe(&mut self) -> UcoeW<Uca2statwSpiSpec> {
        UcoeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Framing error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucfe(&mut self) -> UcfeW<Uca2statwSpiSpec> {
        UcfeW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Listen enable"]
    #[inline(always)]
    #[must_use]
    pub fn uclisten(&mut self) -> UclistenW<Uca2statwSpiSpec> {
        UclistenW::new(self, 7)
    }
}
#[doc = "UCA2STATW_SPI\n\nYou can [`read`](crate::Reg::read) this register and get [`uca2statw_spi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca2statw_spi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca2statwSpiSpec;
impl crate::RegisterSpec for Uca2statwSpiSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca2statw_spi::R`](R) reader structure"]
impl crate::Readable for Uca2statwSpiSpec {}
#[doc = "`write(|w| ..)` method takes [`uca2statw_spi::W`](W) writer structure"]
impl crate::Writable for Uca2statwSpiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA2STATW_SPI to value 0"]
impl crate::Resettable for Uca2statwSpiSpec {
