#[doc = "Register `UCA2IE` reader"]
pub type R = crate::R<Uca2ieSpec>;
#[doc = "Register `UCA2IE` writer"]
pub type W = crate::W<Uca2ieSpec>;
#[doc = "0:0\\]
...
Receive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxie(&mut self) -> UcrxieW<Uca2ieSpec> {
        UcrxieW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn uctxie(&mut self) -> UctxieW<Uca2ieSpec> {
        UctxieW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Start bit interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucsttie(&mut self) -> UcsttieW<Uca2ieSpec> {
        UcsttieW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Transmit complete interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn uctxcptie(&mut self) -> UctxcptieW<Uca2ieSpec> {
        UctxcptieW::new(self, 3)
    }
}
#[doc = "eUSCI_Ax Interrupt Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca2ie::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca2ie::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca2ieSpec;
impl crate::RegisterSpec for Uca2ieSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca2ie::R`](R) reader structure"]
impl crate::Readable for Uca2ieSpec {}
#[doc = "`write(|w| ..)` method takes [`uca2ie::W`](W) writer structure"]
impl crate::Writable for Uca2ieSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA2IE to value 0"]
impl crate::Resettable for Uca2ieSpec {
