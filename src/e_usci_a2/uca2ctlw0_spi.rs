#[doc = "Register `UCA2CTLW0_SPI` reader"]
pub type R = crate::R<Uca2ctlw0SpiSpec>;
#[doc = "Register `UCA2CTLW0_SPI` writer"]
pub type W = crate::W<Uca2ctlw0SpiSpec>;
#[doc = "0:0\\]
...
impl UcmodeR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Ucmode> {
        match self.bits {
            0 => Some(Ucmode::Ucmode0),
            1 => Some(Ucmode::Ucmode1),
            2 => Some(Ucmode::Ucmode2),
            _ => None,
        }
    }
    #[doc = "3-pin SPI"]
...
eUSCI mode"]
pub type UcmodeW<'a, REG> = crate::FieldWriter<'a, REG, 2, Ucmode>;
...
Software reset enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucswrst(&mut self) -> UcswrstW<Uca2ctlw0SpiSpec> {
        UcswrstW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
STE mode select in master mode."]
    #[inline(always)]
    #[must_use]
    pub fn ucstem(&mut self) -> UcstemW<Uca2ctlw0SpiSpec> {
        UcstemW::new(self, 1)
    }
    #[doc = "Bits 6:7 - 7:6\\]
eUSCI_A clock source select"]
    #[inline(always)]
    #[must_use]
    pub fn ucssel(&mut self) -> UcsselW<Uca2ctlw0SpiSpec> {
        UcsselW::new(self, 6)
    }
    #[doc = "Bit 8 - 8:8\\]
Synchronous mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucsync(&mut self) -> UcsyncW<Uca2ctlw0SpiSpec> {
        UcsyncW::new(self, 8)
    }
    #[doc = "Bits 9:10 - 10:9\\]
eUSCI mode"]
    #[inline(always)]
    #[must_use]
    pub fn ucmode(&mut self) -> UcmodeW<Uca2ctlw0SpiSpec> {
        UcmodeW::new(self, 9)
    }
    #[doc = "Bit 11 - 11:11\\]
Master mode select"]
    #[inline(always)]
    #[must_use]
    pub fn ucmst(&mut self) -> UcmstW<Uca2ctlw0SpiSpec> {
        UcmstW::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Character length"]
    #[inline(always)]
    #[must_use]
    pub fn uc7bit(&mut self) -> Uc7bitW<Uca2ctlw0SpiSpec> {
        Uc7bitW::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
MSB first select"]
    #[inline(always)]
    #[must_use]
    pub fn ucmsb(&mut self) -> UcmsbW<Uca2ctlw0SpiSpec> {
        UcmsbW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Clock polarity select"]
    #[inline(always)]
    #[must_use]
    pub fn ucckpl(&mut self) -> UcckplW<Uca2ctlw0SpiSpec> {
        UcckplW::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Clock phase select"]
    #[inline(always)]
    #[must_use]
    pub fn ucckph(&mut self) -> UcckphW<Uca2ctlw0SpiSpec> {
        UcckphW::new(self, 15)
    }
}
#[doc = "eUSCI_Ax Control Word Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`uca2ctlw0_spi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca2ctlw0_spi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca2ctlw0SpiSpec;
impl crate::RegisterSpec for Uca2ctlw0SpiSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca2ctlw0_spi::R`](R) reader structure"]
impl crate::Readable for Uca2ctlw0SpiSpec {}
#[doc = "`write(|w| ..)` method takes [`uca2ctlw0_spi::W`](W) writer structure"]
impl crate::Writable for Uca2ctlw0SpiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA2CTLW0_SPI to value 0"]
impl crate::Resettable for Uca2ctlw0SpiSpec {
