#[doc = "Register `UCA2CTLW1` reader"]
pub type R = crate::R<Uca2ctlw1Spec>;
#[doc = "Register `UCA2CTLW1` writer"]
pub type W = crate::W<Uca2ctlw1Spec>;
#[doc = "1:0\\]
Deglitch time\n\nValue on reset: 0"]
...
Deglitch time"]
    #[inline(always)]
    #[must_use]
    pub fn ucglit(&mut self) -> UcglitW<Uca2ctlw1Spec> {
        UcglitW::new(self, 0)
    }
}
#[doc = "eUSCI_Ax Control Word Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`uca2ctlw1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca2ctlw1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca2ctlw1Spec;
impl crate::RegisterSpec for Uca2ctlw1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca2ctlw1::R`](R) reader structure"]
impl crate::Readable for Uca2ctlw1Spec {}
#[doc = "`write(|w| ..)` method takes [`uca2ctlw1::W`](W) writer structure"]
impl crate::Writable for Uca2ctlw1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA2CTLW1 to value 0"]
impl crate::Resettable for Uca2ctlw1Spec {
