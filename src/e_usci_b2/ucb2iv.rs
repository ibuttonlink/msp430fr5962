#[doc = "Register `UCB2IV` reader"]
pub type R = crate::R<Ucb2ivSpec>;
#[doc = "Register `UCB2IV` writer"]
pub type W = crate::W<Ucb2ivSpec>;
#[doc = "15:0\\]
...
eUSCI_B interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn uciv(&mut self) -> UcivW<Ucb2ivSpec> {
        UcivW::new(self, 0)
    }
}
#[doc = "eUSCI_Bx Interrupt Vector Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb2iv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb2iv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb2ivSpec;
impl crate::RegisterSpec for Ucb2ivSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb2iv::R`](R) reader structure"]
impl crate::Readable for Ucb2ivSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb2iv::W`](W) writer structure"]
impl crate::Writable for Ucb2ivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB2IV to value 0"]
impl crate::Resettable for Ucb2ivSpec {
