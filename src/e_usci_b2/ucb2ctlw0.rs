#[doc = "Register `UCB2CTLW0` reader"]
pub type R = crate::R<Ucb2ctlw0Spec>;
#[doc = "Register `UCB2CTLW0` writer"]
pub type W = crate::W<Ucb2ctlw0Spec>;
#[doc = "0:0\\]
...
#[doc = "Field `UCSLA10` reader - 14:14\\]
Slave addressing mode select"]
...
#[doc = "Field `UCSLA10` writer - 14:14\\]
Slave addressing mode select"]
...
Software reset enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucswrst(&mut self) -> UcswrstW<Ucb2ctlw0Spec> {
        UcswrstW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit START condition in master mode"]
    #[inline(always)]
    #[must_use]
    pub fn uctxstt(&mut self) -> UctxsttW<Ucb2ctlw0Spec> {
        UctxsttW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Transmit STOP condition in master mode"]
    #[inline(always)]
    #[must_use]
    pub fn uctxstp(&mut self) -> UctxstpW<Ucb2ctlw0Spec> {
        UctxstpW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Transmit a NACK"]
    #[inline(always)]
    #[must_use]
    pub fn uctxnack(&mut self) -> UctxnackW<Ucb2ctlw0Spec> {
...
Transmitter/receiver"]
    #[inline(always)]
    #[must_use]
    pub fn uctr(&mut self) -> UctrW<Ucb2ctlw0Spec> {
        UctrW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Transmit ACK condition in slave mode"]
    #[inline(always)]
    #[must_use]
    pub fn uctxack(&mut self) -> UctxackW<Ucb2ctlw0Spec> {
        UctxackW::new(self, 5)
    }
    #[doc = "Bits 6:7 - 7:6\\]
eUSCI_B clock source select"]
    #[inline(always)]
    #[must_use]
    pub fn ucssel(&mut self) -> UcsselW<Ucb2ctlw0Spec> {
        UcsselW::new(self, 6)
    }
    #[doc = "Bit 8 - 8:8\\]
Synchronous mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucsync(&mut self) -> UcsyncW<Ucb2ctlw0Spec> {
        UcsyncW::new(self, 8)
    }
    #[doc = "Bits 9:10 - 10:9\\]
eUSCI_B mode"]
    #[inline(always)]
    #[must_use]
    pub fn ucmode(&mut self) -> UcmodeW<Ucb2ctlw0Spec> {
        UcmodeW::new(self, 9)
    }
    #[doc = "Bit 11 - 11:11\\]
Master mode select"]
    #[inline(always)]
    #[must_use]
    pub fn ucmst(&mut self) -> UcmstW<Ucb2ctlw0Spec> {
        UcmstW::new(self, 11)
    }
    #[doc = "Bit 13 - 13:13\\]
Multi-master environment select"]
    #[inline(always)]
    #[must_use]
    pub fn ucmm(&mut self) -> UcmmW<Ucb2ctlw0Spec> {
        UcmmW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Slave addressing mode select"]
    #[inline(always)]
    #[must_use]
    pub fn ucsla10(&mut self) -> Ucsla10W<Ucb2ctlw0Spec> {
...
Own addressing mode select"]
    #[inline(always)]
    #[must_use]
    pub fn uca10(&mut self) -> Uca10W<Ucb2ctlw0Spec> {
        Uca10W::new(self, 15)
    }
}
#[doc = "eUSCI_Bx Control Word Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb2ctlw0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb2ctlw0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb2ctlw0Spec;
impl crate::RegisterSpec for Ucb2ctlw0Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb2ctlw0::R`](R) reader structure"]
impl crate::Readable for Ucb2ctlw0Spec {}
#[doc = "`write(|w| ..)` method takes [`ucb2ctlw0::W`](W) writer structure"]
impl crate::Writable for Ucb2ctlw0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB2CTLW0 to value 0"]
impl crate::Resettable for Ucb2ctlw0Spec {
