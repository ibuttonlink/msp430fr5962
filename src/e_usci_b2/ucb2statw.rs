#[doc = "Register `UCB2STATW` reader"]
pub type R = crate::R<Ucb2statwSpec>;
#[doc = "Register `UCB2STATW` writer"]
pub type W = crate::W<Ucb2statwSpec>;
#[doc = "4:4\\]
Bus busy\n\nValue on reset: 0"]
...
Bus busy"]
    #[inline(always)]
    #[must_use]
    pub fn ucbbusy(&mut self) -> UcbbusyW<Ucb2statwSpec> {
        UcbbusyW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
General call address received"]
    #[inline(always)]
    #[must_use]
    pub fn ucgc(&mut self) -> UcgcW<Ucb2statwSpec> {
        UcgcW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
SCL low"]
    #[inline(always)]
    #[must_use]
    pub fn ucscllow(&mut self) -> UcscllowW<Ucb2statwSpec> {
...
Hardware byte counter value"]
    #[inline(always)]
    #[must_use]
    pub fn ucbcnt(&mut self) -> UcbcntW<Ucb2statwSpec> {
        UcbcntW::new(self, 8)
    }
}
#[doc = "eUSCI_Bx Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb2statw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb2statw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb2statwSpec;
impl crate::RegisterSpec for Ucb2statwSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb2statw::R`](R) reader structure"]
impl crate::Readable for Ucb2statwSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb2statw::W`](W) writer structure"]
impl crate::Writable for Ucb2statwSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB2STATW to value 0"]
impl crate::Resettable for Ucb2statwSpec {
