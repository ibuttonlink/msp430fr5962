#[doc = "Register `UCB2IFG` reader"]
pub type R = crate::R<Ucb2ifgSpec>;
#[doc = "Register `UCB2IFG` writer"]
pub type W = crate::W<Ucb2ifgSpec>;
#[doc = "0:0\\]
...
eUSCI_B receive interrupt flag 0"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg0(&mut self) -> Ucrxifg0W<Ucb2ifgSpec> {
...
eUSCI_B transmit interrupt flag 0"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg0(&mut self) -> Uctxifg0W<Ucb2ifgSpec> {
...
START condition interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucsttifg(&mut self) -> UcsttifgW<Ucb2ifgSpec> {
...
STOP condition interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucstpifg(&mut self) -> UcstpifgW<Ucb2ifgSpec> {
...
Arbitration lost interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucalifg(&mut self) -> UcalifgW<Ucb2ifgSpec> {
        UcalifgW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Not-acknowledge received interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucnackifg(&mut self) -> UcnackifgW<Ucb2ifgSpec> {
...
Byte counter interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucbcntifg(&mut self) -> UcbcntifgW<Ucb2ifgSpec> {
...
Clock low timeout interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn uccltoifg(&mut self) -> UccltoifgW<Ucb2ifgSpec> {
...
eUSCI_B receive interrupt flag 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg1(&mut self) -> Ucrxifg1W<Ucb2ifgSpec> {
...
eUSCI_B transmit interrupt flag 1"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg1(&mut self) -> Uctxifg1W<Ucb2ifgSpec> {
...
eUSCI_B receive interrupt flag 2"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg2(&mut self) -> Ucrxifg2W<Ucb2ifgSpec> {
...
eUSCI_B transmit interrupt flag 2"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg2(&mut self) -> Uctxifg2W<Ucb2ifgSpec> {
...
eUSCI_B receive interrupt flag 3"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg3(&mut self) -> Ucrxifg3W<Ucb2ifgSpec> {
...
eUSCI_B transmit interrupt flag 3"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg3(&mut self) -> Uctxifg3W<Ucb2ifgSpec> {
...
Bit position 9 interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucbit9ifg(&mut self) -> Ucbit9ifgW<Ucb2ifgSpec> {
        Ucbit9ifgW::new(self, 14)
    }
}
#[doc = "eUSCI_Bx Interrupt Flag Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb2ifg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb2ifg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb2ifgSpec;
impl crate::RegisterSpec for Ucb2ifgSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb2ifg::R`](R) reader structure"]
impl crate::Readable for Ucb2ifgSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb2ifg::W`](W) writer structure"]
impl crate::Writable for Ucb2ifgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB2IFG to value 0"]
impl crate::Resettable for Ucb2ifgSpec {
