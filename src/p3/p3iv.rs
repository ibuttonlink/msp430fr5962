...
#[doc = "Field `P3IV` writer - 4:0\\]
Port 3 interrupt vector value"]
pub type P3ivW<'a, REG> = crate::FieldWriter<'a, REG, 5, P3iv>;
impl<'a, REG> P3ivW<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn none(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::None)
    }
    #[doc = "Interrupt Source: Port 3.0 interrupt; Interrupt Flag: P3IFG0; Interrupt Priority: Highest"]
    #[inline(always)]
    pub fn p3ifg0(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::P3ifg0)
    }
    #[doc = "Interrupt Source: Port 3.1 interrupt; Interrupt Flag: P3IFG1"]
    #[inline(always)]
    pub fn p3ifg1(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::P3ifg1)
    }
    #[doc = "Interrupt Source: Port 3.2 interrupt; Interrupt Flag: P3IFG2"]
    #[inline(always)]
    pub fn p3ifg2(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::P3ifg2)
    }
    #[doc = "Interrupt Source: Port 3.3 interrupt; Interrupt Flag: P3IFG3"]
    #[inline(always)]
    pub fn p3ifg3(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::P3ifg3)
    }
    #[doc = "Interrupt Source: Port 3.4 interrupt; Interrupt Flag: P3IFG4"]
    #[inline(always)]
    pub fn p3ifg4(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::P3ifg4)
    }
    #[doc = "Interrupt Source: Port 3.5 interrupt; Interrupt Flag: P3IFG5"]
    #[inline(always)]
    pub fn p3ifg5(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::P3ifg5)
    }
    #[doc = "Interrupt Source: Port 3.6 interrupt; Interrupt Flag: P3IFG6"]
    #[inline(always)]
    pub fn p3ifg6(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::P3ifg6)
    }
    #[doc = "Interrupt Source: Port 3.7 interrupt; Interrupt Flag: P3IFG7; Interrupt Priority: Lowest"]
    #[inline(always)]
    pub fn p3ifg7(self) -> &'a mut crate::W<REG> {
        self.variant(P3iv::P3ifg7)
    }
}
impl R {
    #[doc = "Bits 0:4 - 4:0\\]
...
Port 3 interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn p3iv(&mut self) -> P3ivW<P3ivSpec> {
        P3ivW::new(self, 0)
    }
}
