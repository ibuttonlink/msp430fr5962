...
#[doc = "Field `P8IV` writer - 4:0\\]
Port 8 interrupt vector value"]
pub type P8ivW<'a, REG> = crate::FieldWriter<'a, REG, 5, P8iv>;
impl<'a, REG> P8ivW<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn none(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::None)
    }
    #[doc = "Interrupt Source: Port 8.0 interrupt; Interrupt Flag: P8IFG0; Interrupt Priority: Highest"]
    #[inline(always)]
    pub fn p8ifg0(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::P8ifg0)
    }
    #[doc = "Interrupt Source: Port 8.1 interrupt; Interrupt Flag: P8IFG1"]
    #[inline(always)]
    pub fn p8ifg1(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::P8ifg1)
    }
    #[doc = "Interrupt Source: Port 8.2 interrupt; Interrupt Flag: P8IFG2"]
    #[inline(always)]
    pub fn p8ifg2(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::P8ifg2)
    }
    #[doc = "Interrupt Source: Port 8.3 interrupt; Interrupt Flag: P8IFG3"]
    #[inline(always)]
    pub fn p8ifg3(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::P8ifg3)
    }
    #[doc = "Interrupt Source: Port 8.4 interrupt; Interrupt Flag: P8IFG4"]
    #[inline(always)]
    pub fn p8ifg4(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::P8ifg4)
    }
    #[doc = "Interrupt Source: Port 8.5 interrupt; Interrupt Flag: P8IFG5"]
    #[inline(always)]
    pub fn p8ifg5(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::P8ifg5)
    }
    #[doc = "Interrupt Source: Port 8.6 interrupt; Interrupt Flag: P8IFG6"]
    #[inline(always)]
    pub fn p8ifg6(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::P8ifg6)
    }
    #[doc = "Interrupt Source: Port 8.7 interrupt; Interrupt Flag: P8IFG7; Interrupt Priority: Lowest"]
    #[inline(always)]
    pub fn p8ifg7(self) -> &'a mut crate::W<REG> {
        self.variant(P8iv::P8ifg7)
    }
}
impl R {
    #[doc = "Bits 0:4 - 4:0\\]
...
Port 8 interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn p8iv(&mut self) -> P8ivW<P8ivSpec> {
        P8ivW::new(self, 0)
    }
}
