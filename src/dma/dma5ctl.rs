#[doc = "Register `DMA5CTL` reader"]
pub type R = crate::R<Dma5ctlSpec>;
#[doc = "Register `DMA5CTL` writer"]
pub type W = crate::W<Dma5ctlSpec>;
#[doc = "0:0\\]
DMA request\n\nValue on reset: 0"]
...
DMA request"]
    #[inline(always)]
    #[must_use]
    pub fn dmareq(&mut self) -> DmareqW<Dma5ctlSpec> {
        DmareqW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
DMA abort"]
    #[inline(always)]
    #[must_use]
    pub fn dmaabort(&mut self) -> DmaabortW<Dma5ctlSpec> {
...
DMA interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaie(&mut self) -> DmaieW<Dma5ctlSpec> {
        DmaieW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
DMA interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmaifg(&mut self) -> DmaifgW<Dma5ctlSpec> {
        DmaifgW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaen(&mut self) -> DmaenW<Dma5ctlSpec> {
        DmaenW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
DMA level"]
    #[inline(always)]
    #[must_use]
    pub fn dmalevel(&mut self) -> DmalevelW<Dma5ctlSpec> {
...
DMA source byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcbyte(&mut self) -> DmasrcbyteW<Dma5ctlSpec> {
...
DMA destination byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstbyte(&mut self) -> DmadstbyteW<Dma5ctlSpec> {
...
DMA source increment"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcincr(&mut self) -> DmasrcincrW<Dma5ctlSpec> {
...
DMA destination increment"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstincr(&mut self) -> DmadstincrW<Dma5ctlSpec> {
...
DMA transfer mode"]
    #[inline(always)]
    #[must_use]
    pub fn dmadt(&mut self) -> DmadtW<Dma5ctlSpec> {
        DmadtW::new(self, 12)
    }
}
#[doc = "DMA Channel 5 Control\n\nYou can [`read`](crate::Reg::read) this register and get [`dma5ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma5ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dma5ctlSpec;
impl crate::RegisterSpec for Dma5ctlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`dma5ctl::R`](R) reader structure"]
impl crate::Readable for Dma5ctlSpec {}
#[doc = "`write(|w| ..)` method takes [`dma5ctl::W`](W) writer structure"]
impl crate::Writable for Dma5ctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DMA5CTL to value 0"]
impl crate::Resettable for Dma5ctlSpec {
