...
DMA request"]
    #[inline(always)]
    #[must_use]
    pub fn dmareq(&mut self) -> DmareqW<Dma2ctlSpec> {
        DmareqW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
DMA abort"]
    #[inline(always)]
    #[must_use]
    pub fn dmaabort(&mut self) -> DmaabortW<Dma2ctlSpec> {
...
DMA interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaie(&mut self) -> DmaieW<Dma2ctlSpec> {
        DmaieW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
DMA interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmaifg(&mut self) -> DmaifgW<Dma2ctlSpec> {
        DmaifgW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaen(&mut self) -> DmaenW<Dma2ctlSpec> {
        DmaenW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
DMA level"]
    #[inline(always)]
    #[must_use]
    pub fn dmalevel(&mut self) -> DmalevelW<Dma2ctlSpec> {
...
DMA source byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcbyte(&mut self) -> DmasrcbyteW<Dma2ctlSpec> {
...
DMA destination byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstbyte(&mut self) -> DmadstbyteW<Dma2ctlSpec> {
...
DMA source increment"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcincr(&mut self) -> DmasrcincrW<Dma2ctlSpec> {
...
DMA destination increment"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstincr(&mut self) -> DmadstincrW<Dma2ctlSpec> {
...
DMA transfer mode"]
    #[inline(always)]
    #[must_use]
    pub fn dmadt(&mut self) -> DmadtW<Dma2ctlSpec> {
        DmadtW::new(self, 12)
    }
}
