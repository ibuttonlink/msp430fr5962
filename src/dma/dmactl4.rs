...
#[doc = "Field `ROUNDROBIN` reader - 1:1\\]
Round robin"]
...
#[doc = "Field `ROUNDROBIN` writer - 1:1\\]
Round robin"]
...
#[doc = "Field `DMARMWDIS` reader - 2:2\\]
Read-modify-write disable"]
...
#[doc = "Field `DMARMWDIS` writer - 2:2\\]
Read-modify-write disable"]
