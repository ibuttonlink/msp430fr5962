#[doc = "Register `DMA3CTL` reader"]
pub type R = crate::R<Dma3ctlSpec>;
#[doc = "Register `DMA3CTL` writer"]
pub type W = crate::W<Dma3ctlSpec>;
#[doc = "0:0\\]
DMA request\n\nValue on reset: 0"]
...
DMA request"]
    #[inline(always)]
    #[must_use]
    pub fn dmareq(&mut self) -> DmareqW<Dma3ctlSpec> {
        DmareqW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
DMA abort"]
    #[inline(always)]
    #[must_use]
    pub fn dmaabort(&mut self) -> DmaabortW<Dma3ctlSpec> {
...
DMA interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaie(&mut self) -> DmaieW<Dma3ctlSpec> {
        DmaieW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
DMA interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmaifg(&mut self) -> DmaifgW<Dma3ctlSpec> {
        DmaifgW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaen(&mut self) -> DmaenW<Dma3ctlSpec> {
        DmaenW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
DMA level"]
    #[inline(always)]
    #[must_use]
    pub fn dmalevel(&mut self) -> DmalevelW<Dma3ctlSpec> {
...
DMA source byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcbyte(&mut self) -> DmasrcbyteW<Dma3ctlSpec> {
...
DMA destination byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstbyte(&mut self) -> DmadstbyteW<Dma3ctlSpec> {
...
DMA source increment"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcincr(&mut self) -> DmasrcincrW<Dma3ctlSpec> {
...
DMA destination increment"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstincr(&mut self) -> DmadstincrW<Dma3ctlSpec> {
...
DMA transfer mode"]
    #[inline(always)]
    #[must_use]
    pub fn dmadt(&mut self) -> DmadtW<Dma3ctlSpec> {
        DmadtW::new(self, 12)
    }
}
#[doc = "DMA Channel 3 Control\n\nYou can [`read`](crate::Reg::read) this register and get [`dma3ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma3ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dma3ctlSpec;
impl crate::RegisterSpec for Dma3ctlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`dma3ctl::R`](R) reader structure"]
impl crate::Readable for Dma3ctlSpec {}
#[doc = "`write(|w| ..)` method takes [`dma3ctl::W`](W) writer structure"]
impl crate::Writable for Dma3ctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets DMA3CTL to value 0"]
impl crate::Resettable for Dma3ctlSpec {
