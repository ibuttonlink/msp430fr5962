...
DMA request"]
    #[inline(always)]
    #[must_use]
    pub fn dmareq(&mut self) -> DmareqW<Dma1ctlSpec> {
        DmareqW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
DMA abort"]
    #[inline(always)]
    #[must_use]
    pub fn dmaabort(&mut self) -> DmaabortW<Dma1ctlSpec> {
...
DMA interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaie(&mut self) -> DmaieW<Dma1ctlSpec> {
        DmaieW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
DMA interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmaifg(&mut self) -> DmaifgW<Dma1ctlSpec> {
        DmaifgW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaen(&mut self) -> DmaenW<Dma1ctlSpec> {
        DmaenW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
DMA level"]
    #[inline(always)]
    #[must_use]
    pub fn dmalevel(&mut self) -> DmalevelW<Dma1ctlSpec> {
...
DMA source byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcbyte(&mut self) -> DmasrcbyteW<Dma1ctlSpec> {
...
DMA destination byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstbyte(&mut self) -> DmadstbyteW<Dma1ctlSpec> {
...
DMA source increment"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcincr(&mut self) -> DmasrcincrW<Dma1ctlSpec> {
...
DMA destination increment"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstincr(&mut self) -> DmadstincrW<Dma1ctlSpec> {
...
DMA transfer mode"]
    #[inline(always)]
    #[must_use]
    pub fn dmadt(&mut self) -> DmadtW<Dma1ctlSpec> {
        DmadtW::new(self, 12)
    }
}
