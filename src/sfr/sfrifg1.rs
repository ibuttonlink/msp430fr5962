...
#[doc = "Field `JMBOUTIFG` reader - 7:7\\]
JTAG mailbox output interrupt flag"]
...
#[doc = "Field `JMBOUTIFG` writer - 7:7\\]
JTAG mailbox output interrupt flag"]
