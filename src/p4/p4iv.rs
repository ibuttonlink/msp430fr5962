...
#[doc = "Field `P4IV` writer - 4:0\\]
Port 4 interrupt vector value"]
pub type P4ivW<'a, REG> = crate::FieldWriter<'a, REG, 5, P4iv>;
impl<'a, REG> P4ivW<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn none(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::None)
    }
    #[doc = "Interrupt Source: Port 4.0 interrupt; Interrupt Flag: P4IFG0; Interrupt Priority: Highest"]
    #[inline(always)]
    pub fn p4ifg0(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::P4ifg0)
    }
    #[doc = "Interrupt Source: Port 4.1 interrupt; Interrupt Flag: P4IFG1"]
    #[inline(always)]
    pub fn p4ifg1(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::P4ifg1)
    }
    #[doc = "Interrupt Source: Port 4.2 interrupt; Interrupt Flag: P4IFG2"]
    #[inline(always)]
    pub fn p4ifg2(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::P4ifg2)
    }
    #[doc = "Interrupt Source: Port 4.3 interrupt; Interrupt Flag: P4IFG3"]
    #[inline(always)]
    pub fn p4ifg3(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::P4ifg3)
    }
    #[doc = "Interrupt Source: Port 4.4 interrupt; Interrupt Flag: P4IFG4"]
    #[inline(always)]
    pub fn p4ifg4(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::P4ifg4)
    }
    #[doc = "Interrupt Source: Port 4.5 interrupt; Interrupt Flag: P4IFG5"]
    #[inline(always)]
    pub fn p4ifg5(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::P4ifg5)
    }
    #[doc = "Interrupt Source: Port 4.6 interrupt; Interrupt Flag: P4IFG6"]
    #[inline(always)]
    pub fn p4ifg6(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::P4ifg6)
    }
    #[doc = "Interrupt Source: Port 4.7 interrupt; Interrupt Flag: P4IFG7; Interrupt Priority: Lowest"]
    #[inline(always)]
    pub fn p4ifg7(self) -> &'a mut crate::W<REG> {
        self.variant(P4iv::P4ifg7)
    }
}
impl R {
    #[doc = "Bits 0:4 - 4:0\\]
...
Port 4 interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn p4iv(&mut self) -> P4ivW<P4ivSpec> {
        P4ivW::new(self, 0)
    }
}
