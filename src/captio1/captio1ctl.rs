...
#[doc = "Field `CAPTIOPISEL1` reader - 3:1\\]
Capacitive Touch IO pin select"]
...
#[doc = "Field `CAPTIOPISEL1` writer - 3:1\\]
Capacitive Touch IO pin select"]
...
#[doc = "Field `CAPTIOPOSEL1` reader - 7:4\\]
Capacitive Touch IO port select"]
...
#[doc = "Field `CAPTIOPOSEL1` writer - 7:4\\]
Capacitive Touch IO port select"]
...
#[doc = "Field `CAPTIO` writer - 9:9\\]
Capacitive Touch IO state"]
pub type CaptioW<'a, REG> = crate::BitWriter<'a, REG, Captio>;
impl<'a, REG> CaptioW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Curent state 0 or Capacitive Touch IO is disabled"]
    #[inline(always)]
    pub fn captio_0(self) -> &'a mut crate::W<REG> {
        self.variant(Captio::Captio0)
    }
    #[doc = "Current state 1"]
    #[inline(always)]
    pub fn captio_1(self) -> &'a mut crate::W<REG> {
        self.variant(Captio::Captio1)
    }
}
impl R {
    #[doc = "Bits 1:3 - 3:1\\]
...
Capacitive Touch IO state"]
    #[inline(always)]
    #[must_use]
    pub fn captio(&mut self) -> CaptioW<Captio1ctlSpec> {
        CaptioW::new(self, 9)
    }
}
