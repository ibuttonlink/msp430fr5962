...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0W<PcrenSpec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1W<PcrenSpec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - P2"]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2W<PcrenSpec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - P3"]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3W<PcrenSpec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - P4"]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4W<PcrenSpec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - P5"]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5W<PcrenSpec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - P6"]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6W<PcrenSpec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - P7"]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7W<PcrenSpec> {
        P7W::new(self, 7)
    }
    #[doc = "Bit 8 - P8"]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8W<PcrenSpec> {
        P8W::new(self, 8)
    }
    #[doc = "Bit 9 - P9"]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9W<PcrenSpec> {
        P9W::new(self, 9)
    }
    #[doc = "Bit 10 - P10"]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10W<PcrenSpec> {
        P10W::new(self, 10)
    }
    #[doc = "Bit 11 - P11"]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11W<PcrenSpec> {
        P11W::new(self, 11)
    }
    #[doc = "Bit 12 - P12"]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12W<PcrenSpec> {
        P12W::new(self, 12)
    }
    #[doc = "Bit 13 - P13"]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13W<PcrenSpec> {
        P13W::new(self, 13)
    }
    #[doc = "Bit 14 - P14"]
    #[inline(always)]
    #[must_use]
    pub fn p14(&mut self) -> P14W<PcrenSpec> {
        P14W::new(self, 14)
    }
    #[doc = "Bit 15 - P15"]
    #[inline(always)]
    #[must_use]
    pub fn p15(&mut self) -> P15W<PcrenSpec> {
        P15W::new(self, 15)
    }
}
