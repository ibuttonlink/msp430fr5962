...
impl RtcsselR {
    ...
    #[doc = "Output from RT1PS"]
    #[inline(always)]
    pub fn is_rt1ps_(&self) -> bool {
        *self == Rtcssel::Rt1ps_
    }
}
#[doc = "Field `RTCSSEL` writer - 3:2\\]
Real-time clock source select"]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "32-kHz crystal oscillator clock"]
    #[inline(always)]
    pub fn lfxt_(self) -> &'a mut crate::W<REG> {
        self.variant(Rtcssel::Lfxt_)
    }
    #[doc = "Output from RT1PS"]
    #[inline(always)]
    ...
    #[doc = "Output from RT1PS"]
    #[inline(always)]
    pub fn rt1ps_(self) -> &'a mut crate::W<REG> {
        self.variant(Rtcssel::Rt1ps_)
    }
}
#[doc = "4:4\\]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "RTC time values in transition"]
    #[inline(always)]
    pub fn rtcrdy_0(self) -> &'a mut crate::W<REG> {
        self.variant(Rtcrdy::Rtcrdy0)
    }
    #[doc = "RTC time values safe for reading. This bit indicates when the real-time clock time values are safe for reading."]
    #[inline(always)]
    pub fn rtcrdy_1(self) -> &'a mut crate::W<REG> {
        self.variant(Rtcrdy::Rtcrdy1)
    }
}
#[doc = "\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `RTCMODE` writer - "]
pub type RtcmodeW<'a, REG> = crate::BitWriter<'a, REG, Rtcmode>;
impl<'a, REG> RtcmodeW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Calendar mode. Always reads a value of 1."]
    #[inline(always)]
    pub fn rtcmode_1(self) -> &'a mut crate::W<REG> {
        self.variant(Rtcmode::Rtcmode1)
    }
}
#[doc = "6:6\\]
...
Real-time clock ready"]
    #[inline(always)]
    #[must_use]
    pub fn rtcrdy(&mut self) -> RtcrdyW<Rtcctl13Spec> {
        RtcrdyW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn rtcmode(&mut self) -> RtcmodeW<Rtcctl13Spec> {
        RtcmodeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Real-time clock hold"]
