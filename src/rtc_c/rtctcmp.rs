...
#[doc = "Field `RTCTCOK` reader - 13:13\\]
Real-time clock temperature compensation write OK"]
...
#[doc = "Field `RTCTCOK` writer - 13:13\\]
Real-time clock temperature compensation write OK"]
pub type RtctcokW<'a, REG> = crate::BitWriter<'a, REG, Rtctcok>;
impl<'a, REG> RtctcokW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Write to RTCTCMPx is unsuccessful"]
    #[inline(always)]
    pub fn rtctcok_0(self) -> &'a mut crate::W<REG> {
        self.variant(Rtctcok::Rtctcok0)
    }
    #[doc = "Write to RTCTCMPx is successful"]
    #[inline(always)]
    pub fn rtctcok_1(self) -> &'a mut crate::W<REG> {
        self.variant(Rtctcok::Rtctcok1)
    }
}
#[doc = "Field `RTCTCRDY` reader - 14:14\\]
Real-time clock temperature compensation ready"]
pub type RtctcrdyR = crate::BitReader;
#[doc = "Field `RTCTCRDY` writer - 14:14\\]
Real-time clock temperature compensation ready"]
pub type RtctcrdyW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "15:15\\]
...
#[doc = "Field `RTCTCMPS` reader - 15:15\\]
Real-time clock temperature compensation sign"]
...
#[doc = "Field `RTCTCMPS` writer - 15:15\\]
Real-time clock temperature compensation sign"]
...
Real-time clock temperature compensation write OK"]
    #[inline(always)]
    #[must_use]
    pub fn rtctcok(&mut self) -> RtctcokW<RtctcmpSpec> {
        RtctcokW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Real-time clock temperature compensation ready"]
    #[inline(always)]
    #[must_use]
    pub fn rtctcrdy(&mut self) -> RtctcrdyW<RtctcmpSpec> {
        RtctcrdyW::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Real-time clock temperature compensation sign"]
    #[inline(always)]
