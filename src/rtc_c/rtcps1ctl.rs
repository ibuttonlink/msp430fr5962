...
#[doc = "Field `RT1PSHOLD` reader - 8:8\\]
Prescale timer 1 hold"]
...
#[doc = "Field `RT1PSHOLD` writer - 8:8\\]
Prescale timer 1 hold"]
...
#[doc = "Field `RT1PSDIV` reader - 13:11\\]
Prescale timer 1 clock divide"]
...
#[doc = "Field `RT1PSDIV` writer - 13:11\\]
Prescale timer 1 clock divide"]
...
#[doc = "Field `RT1SSEL` reader - 15:14\\]
Prescale timer 1 clock source select"]
...
impl Rt1sselR {
    ...
    #[doc = "Output from RT0PS"]
    #[inline(always)]
    pub fn is_rt0ps_(&self) -> bool {
        *self == Rt1ssel::Rt0ps_
    }
}
#[doc = "Field `RT1SSEL` writer - 15:14\\]
Prescale timer 1 clock source select"]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Output from RT0PS"]
    #[inline(always)]
    pub fn rt0ps_(self) -> &'a mut crate::W<REG> {
        self.variant(Rt1ssel::Rt0ps_)
    }
}
impl R {
    #[doc = "Bit 0 - 0:0\\]
