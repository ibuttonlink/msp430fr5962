...
#[doc = "Field `CAPTIOPISEL0` reader - 3:1\\]
Capacitive Touch IO pin select"]
...
#[doc = "Field `CAPTIOPISEL0` writer - 3:1\\]
Capacitive Touch IO pin select"]
...
#[doc = "Field `CAPTIOPOSEL0` reader - 7:4\\]
Capacitive Touch IO port select"]
...
#[doc = "Field `CAPTIOPOSEL0` writer - 7:4\\]
Capacitive Touch IO port select"]
...
Capacitive Touch IO state"]
    #[inline(always)]
    #[must_use]
    pub fn captio(&mut self) -> CaptioW<Captio0ctlSpec> {
        CaptioW::new(self, 9)
    }
}
