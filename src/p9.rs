...
impl RegisterBlock {
    #[doc = "0x80 - Port 9 Input"]
    #[inline(always)]
    pub const fn p9in(&self) -> &P9in {
        &self.p9in
    }
    #[doc = "0x82 - Port 9 Output"]
    #[inline(always)]
    pub const fn p9out(&self) -> &P9out {
        &self.p9out
    }
    #[doc = "0x84 - Port 9 Direction"]
    #[inline(always)]
    pub const fn p9dir(&self) -> &P9dir {
        &self.p9dir
    }
    #[doc = "0x86 - Port 9 Resistor Enable"]
    #[inline(always)]
    pub const fn p9ren(&self) -> &P9ren {
        &self.p9ren
    }
    #[doc = "0x8a - Port 9 Select 0"]
    #[inline(always)]
    pub const fn p9sel0(&self) -> &P9sel0 {
        &self.p9sel0
    }
    #[doc = "0x8c - Port 9 Select 1"]
    #[inline(always)]
    ...
    #[doc = "0x96 - Port 9 Complement Select"]
    #[inline(always)]
    pub const fn p9selc(&self) -> &P9selc {
        &self.p9selc
    }
    #[doc = "0x98 - Port 9 Interrupt Edge Select"]
    #[inline(always)]
    pub const fn p9ies(&self) -> &P9ies {
        &self.p9ies
    }
    #[doc = "0x9a - Port 9 Interrupt Enable"]
    #[inline(always)]
    pub const fn p9ie(&self) -> &P9ie {
        &self.p9ie
    }
    #[doc = "0x9c - Port 9 Interrupt Flag"]
    #[inline(always)]
