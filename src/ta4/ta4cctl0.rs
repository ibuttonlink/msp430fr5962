#[doc = "Register `TA4CCTL0` reader"]
pub type R = crate::R<Ta4cctl0Spec>;
#[doc = "Register `TA4CCTL0` writer"]
pub type W = crate::W<Ta4cctl0Spec>;
#[doc = "0:0\\]
...
Capture/compare interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ccifg(&mut self) -> CcifgW<Ta4cctl0Spec> {
        CcifgW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Capture overflow"]
    #[inline(always)]
    #[must_use]
    pub fn cov(&mut self) -> CovW<Ta4cctl0Spec> {
        CovW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Output"]
    #[inline(always)]
    #[must_use]
    pub fn out(&mut self) -> OutW<Ta4cctl0Spec> {
        OutW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Capture/compare input"]
    #[inline(always)]
    #[must_use]
    pub fn cci(&mut self) -> CciW<Ta4cctl0Spec> {
        CciW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Capture/compare interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ccie(&mut self) -> CcieW<Ta4cctl0Spec> {
        CcieW::new(self, 4)
    }
    #[doc = "Bits 5:7 - 7:5\\]
Output mode"]
    #[inline(always)]
    #[must_use]
    pub fn outmod(&mut self) -> OutmodW<Ta4cctl0Spec> {
        OutmodW::new(self, 5)
    }
    #[doc = "Bit 8 - 8:8\\]
Capture mode"]
    #[inline(always)]
    #[must_use]
    pub fn cap(&mut self) -> CapW<Ta4cctl0Spec> {
        CapW::new(self, 8)
    }
    #[doc = "Bit 10 - 10:10\\]
Synchronized capture/compare input"]
    #[inline(always)]
    #[must_use]
    pub fn scci(&mut self) -> ScciW<Ta4cctl0Spec> {
        ScciW::new(self, 10)
    }
    #[doc = "Bit 11 - 11:11\\]
Synchronize capture source"]
    #[inline(always)]
    #[must_use]
    pub fn scs(&mut self) -> ScsW<Ta4cctl0Spec> {
        ScsW::new(self, 11)
    }
    #[doc = "Bits 12:13 - 13:12\\]
Capture/compare input select"]
    #[inline(always)]
    #[must_use]
    pub fn ccis(&mut self) -> CcisW<Ta4cctl0Spec> {
        CcisW::new(self, 12)
    }
    #[doc = "Bits 14:15 - 15:14\\]
Capture mode"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CmW<Ta4cctl0Spec> {
        CmW::new(self, 14)
    }
}
#[doc = "Timer_A Capture/Compare Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ta4cctl0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ta4cctl0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ta4cctl0Spec;
impl crate::RegisterSpec for Ta4cctl0Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ta4cctl0::R`](R) reader structure"]
impl crate::Readable for Ta4cctl0Spec {}
#[doc = "`write(|w| ..)` method takes [`ta4cctl0::W`](W) writer structure"]
impl crate::Writable for Ta4cctl0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TA4CCTL0 to value 0"]
impl crate::Resettable for Ta4cctl0Spec {
