#[doc = "Register `TA4CTL` reader"]
pub type R = crate::R<Ta4ctlSpec>;
#[doc = "Register `TA4CTL` writer"]
pub type W = crate::W<Ta4ctlSpec>;
#[doc = "0:0\\]
...
#[doc = "Field `TACLR` reader - 2:2\\]
TimerA clear"]
pub type TaclrR = crate::BitReader;
#[doc = "Field `TACLR` writer - 2:2\\]
TimerA clear"]
...
TimerA interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn taifg(&mut self) -> TaifgW<Ta4ctlSpec> {
        TaifgW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
TimerA interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn taie(&mut self) -> TaieW<Ta4ctlSpec> {
        TaieW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
TimerA clear"]
    #[inline(always)]
    #[must_use]
    pub fn taclr(&mut self) -> TaclrW<Ta4ctlSpec> {
        TaclrW::new(self, 2)
    }
    #[doc = "Bits 4:5 - 5:4\\]
Mode control"]
    #[inline(always)]
    #[must_use]
    pub fn mc(&mut self) -> McW<Ta4ctlSpec> {
        McW::new(self, 4)
    }
    #[doc = "Bits 6:7 - 7:6\\]
Input divider"]
    #[inline(always)]
    #[must_use]
    pub fn id(&mut self) -> IdW<Ta4ctlSpec> {
        IdW::new(self, 6)
    }
    #[doc = "Bits 8:9 - 9:8\\]
TimerA clock source select"]
    #[inline(always)]
    #[must_use]
    pub fn tassel(&mut self) -> TasselW<Ta4ctlSpec> {
        TasselW::new(self, 8)
    }
}
#[doc = "TimerAx Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ta4ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ta4ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ta4ctlSpec;
impl crate::RegisterSpec for Ta4ctlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ta4ctl::R`](R) reader structure"]
impl crate::Readable for Ta4ctlSpec {}
#[doc = "`write(|w| ..)` method takes [`ta4ctl::W`](W) writer structure"]
impl crate::Writable for Ta4ctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TA4CTL to value 0"]
impl crate::Resettable for Ta4ctlSpec {
