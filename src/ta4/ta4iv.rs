#[doc = "Register `TA4IV` reader"]
pub type R = crate::R<Ta4ivSpec>;
#[doc = "Register `TA4IV` writer"]
pub type W = crate::W<Ta4ivSpec>;
#[doc = "15:0\\]
...
TimerA interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn taiv(&mut self) -> TaivW<Ta4ivSpec> {
        TaivW::new(self, 0)
    }
}
#[doc = "TimerAx Interrupt Vector Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ta4iv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ta4iv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ta4ivSpec;
impl crate::RegisterSpec for Ta4ivSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ta4iv::R`](R) reader structure"]
impl crate::Readable for Ta4ivSpec {}
#[doc = "`write(|w| ..)` method takes [`ta4iv::W`](W) writer structure"]
impl crate::Writable for Ta4ivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TA4IV to value 0"]
impl crate::Resettable for Ta4ivSpec {
