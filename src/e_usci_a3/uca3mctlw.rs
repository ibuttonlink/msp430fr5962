#[doc = "Register `UCA3MCTLW` reader"]
pub type R = crate::R<Uca3mctlwSpec>;
#[doc = "Register `UCA3MCTLW` writer"]
pub type W = crate::W<Uca3mctlwSpec>;
#[doc = "0:0\\]
...
Oversampling mode enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ucos16(&mut self) -> Ucos16W<Uca3mctlwSpec> {
        Ucos16W::new(self, 0)
    }
    #[doc = "Bits 4:7 - 7:4\\]
First modulation stage select"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrf(&mut self) -> UcbrfW<Uca3mctlwSpec> {
        UcbrfW::new(self, 4)
    }
    #[doc = "Bits 8:15 - 15:8\\]
Second modulation stage select"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs(&mut self) -> UcbrsW<Uca3mctlwSpec> {
        UcbrsW::new(self, 8)
    }
}
#[doc = "eUSCI_Ax Modulation Control Word Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3mctlw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3mctlw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3mctlwSpec;
impl crate::RegisterSpec for Uca3mctlwSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3mctlw::R`](R) reader structure"]
impl crate::Readable for Uca3mctlwSpec {}
#[doc = "`write(|w| ..)` method takes [`uca3mctlw::W`](W) writer structure"]
impl crate::Writable for Uca3mctlwSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3MCTLW to value 0"]
impl crate::Resettable for Uca3mctlwSpec {
