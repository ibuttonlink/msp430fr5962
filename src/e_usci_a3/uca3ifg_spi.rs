#[doc = "Register `UCA3IFG_SPI` reader"]
pub type R = crate::R<Uca3ifgSpiSpec>;
#[doc = "Register `UCA3IFG_SPI` writer"]
pub type W = crate::W<Uca3ifgSpiSpec>;
#[doc = "0:0\\]
...
Receive interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg(&mut self) -> UcrxifgW<Uca3ifgSpiSpec> {
        UcrxifgW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg(&mut self) -> UctxifgW<Uca3ifgSpiSpec> {
        UctxifgW::new(self, 1)
    }
}
#[doc = "eUSCI_Ax Interrupt Flag Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3ifg_spi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3ifg_spi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3ifgSpiSpec;
impl crate::RegisterSpec for Uca3ifgSpiSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3ifg_spi::R`](R) reader structure"]
impl crate::Readable for Uca3ifgSpiSpec {}
#[doc = "`write(|w| ..)` method takes [`uca3ifg_spi::W`](W) writer structure"]
impl crate::Writable for Uca3ifgSpiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3IFG_SPI to value 0"]
impl crate::Resettable for Uca3ifgSpiSpec {
