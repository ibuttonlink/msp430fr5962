#[doc = "Register `UCA3STATW` reader"]
pub type R = crate::R<Uca3statwSpec>;
#[doc = "Register `UCA3STATW` writer"]
pub type W = crate::W<Uca3statwSpec>;
#[doc = "0:0\\]
eUSCI_A busy\n\nValue on reset: 0"]
...
#[doc = "Field `UCBUSY` writer - 0:0\\]
eUSCI_A busy"]
pub type UcbusyW<'a, REG> = crate::BitWriter<'a, REG, Ucbusy>;
impl<'a, REG> UcbusyW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn idle(self) -> &'a mut crate::W<REG> {
        self.variant(Ucbusy::Idle)
    }
    #[doc = "eUSCI_A transmitting or receiving"]
    #[inline(always)]
    pub fn busy(self) -> &'a mut crate::W<REG> {
        self.variant(Ucbusy::Busy)
    }
}
#[doc = "Field `UCADDR_UCIDLE` reader - 1:1\\]
Address received / Idle line detected"]
pub type UcaddrUcidleR = crate::BitReader;
#[doc = "Field `UCADDR_UCIDLE` writer - 1:1\\]
Address received / Idle line detected"]
...
eUSCI_A busy"]
    #[inline(always)]
    #[must_use]
    pub fn ucbusy(&mut self) -> UcbusyW<Uca3statwSpec> {
        UcbusyW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Address received / Idle line detected"]
    #[inline(always)]
    #[must_use]
    pub fn ucaddr_ucidle(&mut self) -> UcaddrUcidleW<Uca3statwSpec> {
...
Receive error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxerr(&mut self) -> UcrxerrW<Uca3statwSpec> {
        UcrxerrW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Break detect flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrk(&mut self) -> UcbrkW<Uca3statwSpec> {
        UcbrkW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Parity error flag. When UCPEN = 0, UCPE is read as 0. UCPE is cleared when UCAxRXBUF is read."]
    #[inline(always)]
    #[must_use]
    pub fn ucpe(&mut self) -> UcpeW<Uca3statwSpec> {
        UcpeW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Overrun error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucoe(&mut self) -> UcoeW<Uca3statwSpec> {
        UcoeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Framing error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucfe(&mut self) -> UcfeW<Uca3statwSpec> {
        UcfeW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Listen enable"]
    #[inline(always)]
    #[must_use]
    pub fn uclisten(&mut self) -> UclistenW<Uca3statwSpec> {
        UclistenW::new(self, 7)
    }
}
#[doc = "eUSCI_Ax Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3statw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3statw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3statwSpec;
impl crate::RegisterSpec for Uca3statwSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3statw::R`](R) reader structure"]
impl crate::Readable for Uca3statwSpec {}
#[doc = "`write(|w| ..)` method takes [`uca3statw::W`](W) writer structure"]
impl crate::Writable for Uca3statwSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3STATW to value 0"]
impl crate::Resettable for Uca3statwSpec {
