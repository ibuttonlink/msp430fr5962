#[doc = "Register `UCA3IFG` reader"]
pub type R = crate::R<Uca3ifgSpec>;
#[doc = "Register `UCA3IFG` writer"]
pub type W = crate::W<Uca3ifgSpec>;
#[doc = "0:0\\]
...
Receive interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg(&mut self) -> UcrxifgW<Uca3ifgSpec> {
        UcrxifgW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg(&mut self) -> UctxifgW<Uca3ifgSpec> {
        UctxifgW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Start bit interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucsttifg(&mut self) -> UcsttifgW<Uca3ifgSpec> {
...
Transmit ready interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn uctxcptifg(&mut self) -> UctxcptifgW<Uca3ifgSpec> {
        UctxcptifgW::new(self, 3)
    }
}
#[doc = "eUSCI_Ax Interrupt Flag Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3ifg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3ifg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3ifgSpec;
impl crate::RegisterSpec for Uca3ifgSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3ifg::R`](R) reader structure"]
impl crate::Readable for Uca3ifgSpec {}
#[doc = "`write(|w| ..)` method takes [`uca3ifg::W`](W) writer structure"]
impl crate::Writable for Uca3ifgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3IFG to value 0"]
impl crate::Resettable for Uca3ifgSpec {
