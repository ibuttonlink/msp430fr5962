#[doc = "Register `UCA3IE_SPI` reader"]
pub type R = crate::R<Uca3ieSpiSpec>;
#[doc = "Register `UCA3IE_SPI` writer"]
pub type W = crate::W<Uca3ieSpiSpec>;
#[doc = "0:0\\]
...
Receive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxie(&mut self) -> UcrxieW<Uca3ieSpiSpec> {
        UcrxieW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn uctxie(&mut self) -> UctxieW<Uca3ieSpiSpec> {
        UctxieW::new(self, 1)
    }
}
#[doc = "eUSCI_Ax Interrupt Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3ie_spi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3ie_spi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3ieSpiSpec;
impl crate::RegisterSpec for Uca3ieSpiSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3ie_spi::R`](R) reader structure"]
impl crate::Readable for Uca3ieSpiSpec {}
#[doc = "`write(|w| ..)` method takes [`uca3ie_spi::W`](W) writer structure"]
impl crate::Writable for Uca3ieSpiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3IE_SPI to value 0"]
impl crate::Resettable for Uca3ieSpiSpec {
