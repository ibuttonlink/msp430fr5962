#[doc = "Register `UCA3CTLW0` reader"]
pub type R = crate::R<Uca3ctlw0Spec>;
#[doc = "Register `UCA3CTLW0` writer"]
pub type W = crate::W<Uca3ctlw0Spec>;
#[doc = "0:0\\]
...
Software reset enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucswrst(&mut self) -> UcswrstW<Uca3ctlw0Spec> {
        UcswrstW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit break"]
    #[inline(always)]
    #[must_use]
    pub fn uctxbrk(&mut self) -> UctxbrkW<Uca3ctlw0Spec> {
        UctxbrkW::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
Transmit address"]
    #[inline(always)]
    #[must_use]
    pub fn uctxaddr(&mut self) -> UctxaddrW<Uca3ctlw0Spec> {
...
Dormant"]
    #[inline(always)]
    #[must_use]
    pub fn ucdorm(&mut self) -> UcdormW<Uca3ctlw0Spec> {
        UcdormW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Receive break character interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrkie(&mut self) -> UcbrkieW<Uca3ctlw0Spec> {
        UcbrkieW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Receive erroneous-character interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxeie(&mut self) -> UcrxeieW<Uca3ctlw0Spec> {
        UcrxeieW::new(self, 5)
    }
    #[doc = "Bits 6:7 - 7:6\\]
eUSCI_A clock source select"]
    #[inline(always)]
    #[must_use]
    pub fn ucssel(&mut self) -> UcsselW<Uca3ctlw0Spec> {
        UcsselW::new(self, 6)
    }
    #[doc = "Bit 8 - 8:8\\]
Synchronous mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucsync(&mut self) -> UcsyncW<Uca3ctlw0Spec> {
        UcsyncW::new(self, 8)
    }
    #[doc = "Bits 9:10 - 10:9\\]
eUSCI_A mode"]
    #[inline(always)]
    #[must_use]
    pub fn ucmode(&mut self) -> UcmodeW<Uca3ctlw0Spec> {
        UcmodeW::new(self, 9)
    }
    #[doc = "Bit 11 - 11:11\\]
Stop bit select"]
    #[inline(always)]
    #[must_use]
    pub fn ucspb(&mut self) -> UcspbW<Uca3ctlw0Spec> {
        UcspbW::new(self, 11)
    }
    #[doc = "Bit 12 - 12:12\\]
Character length"]
    #[inline(always)]
    #[must_use]
    pub fn uc7bit(&mut self) -> Uc7bitW<Uca3ctlw0Spec> {
        Uc7bitW::new(self, 12)
    }
    #[doc = "Bit 13 - 13:13\\]
MSB first select"]
    #[inline(always)]
    #[must_use]
    pub fn ucmsb(&mut self) -> UcmsbW<Uca3ctlw0Spec> {
        UcmsbW::new(self, 13)
    }
    #[doc = "Bit 14 - 14:14\\]
Parity select"]
    #[inline(always)]
    #[must_use]
    pub fn ucpar(&mut self) -> UcparW<Uca3ctlw0Spec> {
        UcparW::new(self, 14)
    }
    #[doc = "Bit 15 - 15:15\\]
Parity enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucpen(&mut self) -> UcpenW<Uca3ctlw0Spec> {
        UcpenW::new(self, 15)
    }
}
#[doc = "eUSCI_Ax Control Word Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3ctlw0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3ctlw0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3ctlw0Spec;
impl crate::RegisterSpec for Uca3ctlw0Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3ctlw0::R`](R) reader structure"]
impl crate::Readable for Uca3ctlw0Spec {}
#[doc = "`write(|w| ..)` method takes [`uca3ctlw0::W`](W) writer structure"]
impl crate::Writable for Uca3ctlw0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3CTLW0 to value 0"]
impl crate::Resettable for Uca3ctlw0Spec {
