#[doc = "Register `UCA3ABCTL` reader"]
pub type R = crate::R<Uca3abctlSpec>;
#[doc = "Register `UCA3ABCTL` writer"]
pub type W = crate::W<Uca3abctlSpec>;
#[doc = "0:0\\]
...
Automatic baud-rate detect enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucabden(&mut self) -> UcabdenW<Uca3abctlSpec> {
        UcabdenW::new(self, 0)
    }
    #[doc = "Bit 2 - 2:2\\]
Break time out error"]
    #[inline(always)]
    #[must_use]
    pub fn ucbtoe(&mut self) -> UcbtoeW<Uca3abctlSpec> {
        UcbtoeW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
Synch field time out error"]
    #[inline(always)]
    #[must_use]
    pub fn ucstoe(&mut self) -> UcstoeW<Uca3abctlSpec> {
        UcstoeW::new(self, 3)
    }
    #[doc = "Bits 4:5 - 5:4\\]
Break/synch delimiter length"]
    #[inline(always)]
    #[must_use]
    pub fn ucdelim(&mut self) -> UcdelimW<Uca3abctlSpec> {
        UcdelimW::new(self, 4)
    }
}
#[doc = "eUSCI_Ax Auto Baud Rate Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3abctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3abctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3abctlSpec;
impl crate::RegisterSpec for Uca3abctlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3abctl::R`](R) reader structure"]
impl crate::Readable for Uca3abctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uca3abctl::W`](W) writer structure"]
impl crate::Writable for Uca3abctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3ABCTL to value 0"]
impl crate::Resettable for Uca3abctlSpec {
