#[doc = "Register `UCA3IV` reader"]
pub type R = crate::R<Uca3ivSpec>;
#[doc = "Register `UCA3IV` writer"]
pub type W = crate::W<Uca3ivSpec>;
#[doc = "15:0\\]
...
eUSCI_A interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn uciv(&mut self) -> UcivW<Uca3ivSpec> {
        UcivW::new(self, 0)
    }
}
#[doc = "eUSCI_Ax Interrupt Vector Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3iv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3iv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3ivSpec;
impl crate::RegisterSpec for Uca3ivSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3iv::R`](R) reader structure"]
impl crate::Readable for Uca3ivSpec {}
#[doc = "`write(|w| ..)` method takes [`uca3iv::W`](W) writer structure"]
impl crate::Writable for Uca3ivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3IV to value 0"]
impl crate::Resettable for Uca3ivSpec {
