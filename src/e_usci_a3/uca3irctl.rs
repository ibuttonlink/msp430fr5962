#[doc = "Register `UCA3IRCTL` reader"]
pub type R = crate::R<Uca3irctlSpec>;
#[doc = "Register `UCA3IRCTL` writer"]
pub type W = crate::W<Uca3irctlSpec>;
#[doc = "0:0\\]
...
IrDA encoder/decoder enable"]
    #[inline(always)]
    #[must_use]
    pub fn uciren(&mut self) -> UcirenW<Uca3irctlSpec> {
        UcirenW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
IrDA transmit pulse clock select"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxclk(&mut self) -> UcirtxclkW<Uca3irctlSpec> {
...
Transmit pulse length"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxpl(&mut self) -> UcirtxplW<Uca3irctlSpec> {
...
IrDA receive filter enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ucirrxfe(&mut self) -> UcirrxfeW<Uca3irctlSpec> {
...
IrDA receive input UCAxRXD polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ucirrxpl(&mut self) -> UcirrxplW<Uca3irctlSpec> {
...
Receive filter length"]
    #[inline(always)]
    #[must_use]
    pub fn ucirrxfl(&mut self) -> UcirrxflW<Uca3irctlSpec> {
        UcirrxflW::new(self, 10)
    }
}
#[doc = "eUSCI_Ax IrDA Control Word Register\n\nYou can [`read`](crate::Reg::read) this register and get [`uca3irctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca3irctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca3irctlSpec;
impl crate::RegisterSpec for Uca3irctlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca3irctl::R`](R) reader structure"]
impl crate::Readable for Uca3irctlSpec {}
#[doc = "`write(|w| ..)` method takes [`uca3irctl::W`](W) writer structure"]
impl crate::Writable for Uca3irctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCA3IRCTL to value 0"]
impl crate::Resettable for Uca3irctlSpec {
