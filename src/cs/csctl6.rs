...
#[doc = "Field `ACLKREQEN` reader - 0:0\\]
ACLK clock request enable"]
...
#[doc = "Field `ACLKREQEN` writer - 0:0\\]
ACLK clock request enable"]
...
#[doc = "Field `MCLKREQEN` reader - 1:1\\]
MCLK clock request enable"]
...
#[doc = "Field `MCLKREQEN` writer - 1:1\\]
MCLK clock request enable"]
...
#[doc = "Field `SMCLKREQEN` reader - 2:2\\]
SMCLK clock request enable"]
...
#[doc = "Field `SMCLKREQEN` writer - 2:2\\]
SMCLK clock request enable"]
...
#[doc = "Field `MODCLKREQEN` reader - 3:3\\]
MODCLK clock request enable"]
...
#[doc = "Field `MODCLKREQEN` writer - 3:3\\]
MODCLK clock request enable"]
