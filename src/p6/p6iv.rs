...
#[doc = "Field `P6IV` writer - 4:0\\]
Port 6 interrupt vector value"]
pub type P6ivW<'a, REG> = crate::FieldWriter<'a, REG, 5, P6iv>;
impl<'a, REG> P6ivW<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn none(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::None)
    }
    #[doc = "Interrupt Source: Port 6.0 interrupt; Interrupt Flag: P6IFG0; Interrupt Priority: Highest"]
    #[inline(always)]
    pub fn p6ifg0(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::P6ifg0)
    }
    #[doc = "Interrupt Source: Port 6.1 interrupt; Interrupt Flag: P6IFG1"]
    #[inline(always)]
    pub fn p6ifg1(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::P6ifg1)
    }
    #[doc = "Interrupt Source: Port 6.2 interrupt; Interrupt Flag: P6IFG2"]
    #[inline(always)]
    pub fn p6ifg2(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::P6ifg2)
    }
    #[doc = "Interrupt Source: Port 6.3 interrupt; Interrupt Flag: P6IFG3"]
    #[inline(always)]
    pub fn p6ifg3(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::P6ifg3)
    }
    #[doc = "Interrupt Source: Port 6.4 interrupt; Interrupt Flag: P6IFG4"]
    #[inline(always)]
    pub fn p6ifg4(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::P6ifg4)
    }
    #[doc = "Interrupt Source: Port 6.5 interrupt; Interrupt Flag: P6IFG5"]
    #[inline(always)]
    pub fn p6ifg5(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::P6ifg5)
    }
    #[doc = "Interrupt Source: Port 6.6 interrupt; Interrupt Flag: P6IFG6"]
    #[inline(always)]
    pub fn p6ifg6(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::P6ifg6)
    }
    #[doc = "Interrupt Source: Port 6.7 interrupt; Interrupt Flag: P6IFG7; Interrupt Priority: Lowest"]
    #[inline(always)]
    pub fn p6ifg7(self) -> &'a mut crate::W<REG> {
        self.variant(P6iv::P6ifg7)
    }
}
impl R {
    #[doc = "Bits 0:4 - 4:0\\]
...
Port 6 interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn p6iv(&mut self) -> P6ivW<P6ivSpec> {
        P6ivW::new(self, 0)
    }
}
