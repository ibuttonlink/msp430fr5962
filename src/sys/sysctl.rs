...
#[doc = "Field `SYSRIVECT` reader - 0:0\\]
RAM-based interrupt vectors"]
...
#[doc = "Field `SYSRIVECT` writer - 0:0\\]
RAM-based interrupt vectors"]
...
#[doc = "Field `SYSBSLIND` reader - 4:4\\]
BSL entry indication"]
...
#[doc = "Field `SYSBSLIND` writer - 4:4\\]
BSL entry indication"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No BSL entry sequence detected"]
    #[inline(always)]
    pub fn sysbslind_0(self) -> &'a mut crate::W<REG> {
        self.variant(Sysbslind::Sysbslind0)
    }
    #[doc = "BSL entry sequence detected"]
    #[inline(always)]
    pub fn sysbslind_1(self) -> &'a mut crate::W<REG> {
        self.variant(Sysbslind::Sysbslind1)
    }
}
#[doc = "5:5\\]
...
#[doc = "Field `SYSJTAGPIN` reader - 5:5\\]
Dedicated JTAG pins enable"]
...
#[doc = "Field `SYSJTAGPIN` writer - 5:5\\]
Dedicated JTAG pins enable"]
