#[doc = "Register `UCB3IFG_SPI` reader"]
pub type R = crate::R<Ucb3ifgSpiSpec>;
#[doc = "Register `UCB3IFG_SPI` writer"]
pub type W = crate::W<Ucb3ifgSpiSpec>;
#[doc = "0:0\\]
...
Receive interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg(&mut self) -> UcrxifgW<Ucb3ifgSpiSpec> {
        UcrxifgW::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg(&mut self) -> UctxifgW<Ucb3ifgSpiSpec> {
        UctxifgW::new(self, 1)
    }
}
#[doc = "eUSCI_Bx Interrupt Flag Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb3ifg_spi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb3ifg_spi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb3ifgSpiSpec;
impl crate::RegisterSpec for Ucb3ifgSpiSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb3ifg_spi::R`](R) reader structure"]
impl crate::Readable for Ucb3ifgSpiSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb3ifg_spi::W`](W) writer structure"]
impl crate::Writable for Ucb3ifgSpiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB3IFG_SPI to value 0"]
impl crate::Resettable for Ucb3ifgSpiSpec {
