#[doc = "Register `UCB3IE` reader"]
pub type R = crate::R<Ucb3ieSpec>;
#[doc = "Register `UCB3IE` writer"]
pub type W = crate::W<Ucb3ieSpec>;
#[doc = "0:0\\]
...
#[doc = "Field `UCRXIE2` reader - 10:10\\]
Receive interrupt enable 2"]
...
#[doc = "Field `UCRXIE2` writer - 10:10\\]
Receive interrupt enable 2"]
...
#[doc = "Field `UCTXIE2` reader - 11:11\\]
Transmit interrupt enable 2"]
...
#[doc = "Field `UCTXIE2` writer - 11:11\\]
Transmit interrupt enable 2"]
...
#[doc = "Field `UCRXIE3` reader - 12:12\\]
Receive interrupt enable 3"]
...
#[doc = "Field `UCRXIE3` writer - 12:12\\]
Receive interrupt enable 3"]
...
#[doc = "Field `UCTXIE3` reader - 13:13\\]
Transmit interrupt enable 3"]
...
#[doc = "Field `UCTXIE3` writer - 13:13\\]
Transmit interrupt enable 3"]
...
#[doc = "Field `UCBIT9IE` reader - 14:14\\]
Bit position 9 interrupt enable"]
...
#[doc = "Field `UCBIT9IE` writer - 14:14\\]
Bit position 9 interrupt enable"]
...
Receive interrupt enable 0"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxie0(&mut self) -> Ucrxie0W<Ucb3ieSpec> {
        Ucrxie0W::new(self, 0)
    }
    #[doc = "Bit 1 - 1:1\\]
Transmit interrupt enable 0"]
    #[inline(always)]
    #[must_use]
    pub fn uctxie0(&mut self) -> Uctxie0W<Ucb3ieSpec> {
        Uctxie0W::new(self, 1)
    }
    #[doc = "Bit 2 - 2:2\\]
START condition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucsttie(&mut self) -> UcsttieW<Ucb3ieSpec> {
        UcsttieW::new(self, 2)
    }
    #[doc = "Bit 3 - 3:3\\]
STOP condition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucstpie(&mut self) -> UcstpieW<Ucb3ieSpec> {
        UcstpieW::new(self, 3)
    }
    #[doc = "Bit 4 - 4:4\\]
Arbitration lost interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucalie(&mut self) -> UcalieW<Ucb3ieSpec> {
        UcalieW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
Not-acknowledge interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucnackie(&mut self) -> UcnackieW<Ucb3ieSpec> {
...
Byte counter interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucbcntie(&mut self) -> UcbcntieW<Ucb3ieSpec> {
...
Clock low timeout interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn uccltoie(&mut self) -> UccltoieW<Ucb3ieSpec> {
...
Receive interrupt enable 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxie1(&mut self) -> Ucrxie1W<Ucb3ieSpec> {
        Ucrxie1W::new(self, 8)
    }
    #[doc = "Bit 9 - 9:9\\]
Transmit interrupt enable 1"]
    #[inline(always)]
    #[must_use]
    pub fn uctxie1(&mut self) -> Uctxie1W<Ucb3ieSpec> {
        Uctxie1W::new(self, 9)
    }
    #[doc = "Bit 10 - 10:10\\]
Receive interrupt enable 2"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxie2(&mut self) -> Ucrxie2W<Ucb3ieSpec> {
...
Transmit interrupt enable 2"]
    #[inline(always)]
    #[must_use]
    pub fn uctxie2(&mut self) -> Uctxie2W<Ucb3ieSpec> {
...
Receive interrupt enable 3"]
    #[inline(always)]
    #[must_use]
    pub fn ucrxie3(&mut self) -> Ucrxie3W<Ucb3ieSpec> {
...
Transmit interrupt enable 3"]
    #[inline(always)]
    #[must_use]
    pub fn uctxie3(&mut self) -> Uctxie3W<Ucb3ieSpec> {
...
Bit position 9 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucbit9ie(&mut self) -> Ucbit9ieW<Ucb3ieSpec> {
        Ucbit9ieW::new(self, 14)
    }
}
#[doc = "eUSCI_Bx Interrupt Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb3ie::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb3ie::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb3ieSpec;
impl crate::RegisterSpec for Ucb3ieSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb3ie::R`](R) reader structure"]
impl crate::Readable for Ucb3ieSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb3ie::W`](W) writer structure"]
impl crate::Writable for Ucb3ieSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB3IE to value 0"]
impl crate::Resettable for Ucb3ieSpec {
