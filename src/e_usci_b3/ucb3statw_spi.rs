#[doc = "Register `UCB3STATW_SPI` reader"]
pub type R = crate::R<Ucb3statwSpiSpec>;
#[doc = "Register `UCB3STATW_SPI` writer"]
pub type W = crate::W<Ucb3statwSpiSpec>;
#[doc = "5:5\\]
Overrun error flag\n\nValue on reset: 0"]
...
Overrun error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucoe(&mut self) -> UcoeW<Ucb3statwSpiSpec> {
        UcoeW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
Framing error flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucfe(&mut self) -> UcfeW<Ucb3statwSpiSpec> {
        UcfeW::new(self, 6)
    }
    #[doc = "Bit 7 - 7:7\\]
Listen enable"]
    #[inline(always)]
    #[must_use]
    pub fn uclisten(&mut self) -> UclistenW<Ucb3statwSpiSpec> {
        UclistenW::new(self, 7)
    }
}
#[doc = "UCB3STATW_SPI\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb3statw_spi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb3statw_spi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb3statwSpiSpec;
impl crate::RegisterSpec for Ucb3statwSpiSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb3statw_spi::R`](R) reader structure"]
impl crate::Readable for Ucb3statwSpiSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb3statw_spi::W`](W) writer structure"]
impl crate::Writable for Ucb3statwSpiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB3STATW_SPI to value 0"]
impl crate::Resettable for Ucb3statwSpiSpec {
