#[doc = "Register `UCB3CTLW1` reader"]
pub type R = crate::R<Ucb3ctlw1Spec>;
#[doc = "Register `UCB3CTLW1` writer"]
pub type W = crate::W<Ucb3ctlw1Spec>;
#[doc = "1:0\\]
Deglitch time\n\nValue on reset: 0"]
...
#[doc = "Field `UCSTPNACK` reader - 5:5\\]
ACK all master bytes"]
...
#[doc = "Field `UCSTPNACK` writer - 5:5\\]
ACK all master bytes"]
...
Deglitch time"]
    #[inline(always)]
    #[must_use]
    pub fn ucglit(&mut self) -> UcglitW<Ucb3ctlw1Spec> {
        UcglitW::new(self, 0)
    }
    #[doc = "Bits 2:3 - 3:2\\]
Automatic STOP condition generation"]
    #[inline(always)]
    #[must_use]
    pub fn ucastp(&mut self) -> UcastpW<Ucb3ctlw1Spec> {
        UcastpW::new(self, 2)
    }
    #[doc = "Bit 4 - 4:4\\]
SW or HW ACK control"]
    #[inline(always)]
    #[must_use]
    pub fn ucswack(&mut self) -> UcswackW<Ucb3ctlw1Spec> {
        UcswackW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
ACK all master bytes"]
    #[inline(always)]
    #[must_use]
    pub fn ucstpnack(&mut self) -> UcstpnackW<Ucb3ctlw1Spec> {
...
Clock low timeout select"]
    #[inline(always)]
    #[must_use]
    pub fn ucclto(&mut self) -> UccltoW<Ucb3ctlw1Spec> {
        UccltoW::new(self, 6)
    }
    #[doc = "Bit 8 - 8:8\\]
Early UCTXIFG0"]
    #[inline(always)]
    #[must_use]
    pub fn ucetxint(&mut self) -> UcetxintW<Ucb3ctlw1Spec> {
        UcetxintW::new(self, 8)
    }
}
#[doc = "eUSCI_Bx Control Word Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb3ctlw1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb3ctlw1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb3ctlw1Spec;
impl crate::RegisterSpec for Ucb3ctlw1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb3ctlw1::R`](R) reader structure"]
impl crate::Readable for Ucb3ctlw1Spec {}
#[doc = "`write(|w| ..)` method takes [`ucb3ctlw1::W`](W) writer structure"]
impl crate::Writable for Ucb3ctlw1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB3CTLW1 to value 0"]
impl crate::Resettable for Ucb3ctlw1Spec {
