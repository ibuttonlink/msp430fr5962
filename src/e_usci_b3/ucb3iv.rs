#[doc = "Register `UCB3IV` reader"]
pub type R = crate::R<Ucb3ivSpec>;
#[doc = "Register `UCB3IV` writer"]
pub type W = crate::W<Ucb3ivSpec>;
#[doc = "15:0\\]
...
eUSCI_B interrupt vector value"]
    #[inline(always)]
    #[must_use]
    pub fn uciv(&mut self) -> UcivW<Ucb3ivSpec> {
        UcivW::new(self, 0)
    }
}
#[doc = "eUSCI_Bx Interrupt Vector Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb3iv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb3iv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb3ivSpec;
impl crate::RegisterSpec for Ucb3ivSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb3iv::R`](R) reader structure"]
impl crate::Readable for Ucb3ivSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb3iv::W`](W) writer structure"]
impl crate::Writable for Ucb3ivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB3IV to value 0"]
impl crate::Resettable for Ucb3ivSpec {
