#[doc = "Register `UCB3I2COA1` reader"]
pub type R = crate::R<Ucb3i2coa1Spec>;
#[doc = "Register `UCB3I2COA1` writer"]
pub type W = crate::W<Ucb3i2coa1Spec>;
...
I2C own address"]
    #[inline(always)]
    #[must_use]
    pub fn i2coa1(&mut self) -> I2coa1W<Ucb3i2coa1Spec> {
        I2coa1W::new(self, 0)
    }
    #[doc = "Bit 10 - 10:10\\]
Own Address enable register"]
    #[inline(always)]
    #[must_use]
    pub fn ucoaen(&mut self) -> UcoaenW<Ucb3i2coa1Spec> {
        UcoaenW::new(self, 10)
    }
}
#[doc = "eUSCI_Bx I2C Own Address 1 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb3i2coa1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb3i2coa1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb3i2coa1Spec;
impl crate::RegisterSpec for Ucb3i2coa1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb3i2coa1::R`](R) reader structure"]
impl crate::Readable for Ucb3i2coa1Spec {}
#[doc = "`write(|w| ..)` method takes [`ucb3i2coa1::W`](W) writer structure"]
impl crate::Writable for Ucb3i2coa1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCB3I2COA1 to value 0"]
impl crate::Resettable for Ucb3i2coa1Spec {
