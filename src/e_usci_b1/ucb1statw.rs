...
Bus busy"]
    #[inline(always)]
    #[must_use]
    pub fn ucbbusy(&mut self) -> UcbbusyW<Ucb1statwSpec> {
        UcbbusyW::new(self, 4)
    }
    #[doc = "Bit 5 - 5:5\\]
General call address received"]
    #[inline(always)]
    #[must_use]
    pub fn ucgc(&mut self) -> UcgcW<Ucb1statwSpec> {
        UcgcW::new(self, 5)
    }
    #[doc = "Bit 6 - 6:6\\]
SCL low"]
    #[inline(always)]
    #[must_use]
    pub fn ucscllow(&mut self) -> UcscllowW<Ucb1statwSpec> {
...
Hardware byte counter value"]
    #[inline(always)]
    #[must_use]
    pub fn ucbcnt(&mut self) -> UcbcntW<Ucb1statwSpec> {
        UcbcntW::new(self, 8)
    }
}
